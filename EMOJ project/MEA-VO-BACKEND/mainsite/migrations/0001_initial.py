    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problems1attempt', models.TextField(default='0')),
                ('points', models.IntegerField(default=0)),
                ('isproblemsetter', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainsite.problem')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
